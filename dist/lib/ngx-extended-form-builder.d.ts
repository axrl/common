...
declare type ScanFormType<T> = T extends FormGroup<infer U> ? ScanFormType<U> : T extends FormArray<infer U> ? ScanFormType<U> : T extends FormControl<infer U> ? ScanFormType<U> : T extends Array<infer U> ? FormArray<ScanFormType<U>> : T extends null | undefined ? never : T extends (string | number | boolean | symbol) ? FormControl<T | null> : FormGroup<{
