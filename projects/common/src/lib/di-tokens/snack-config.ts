 ...
 */
export const SNACK_SERVICE_CONFIG = new InjectionToken<SnackServiceConfig<unknown> | undefined>(
    'SNACK_SERVICE_CONFIG',
    {
        providedIn: 'root',
        factory: (): SnackServiceConfig<unknown> | undefined => undefined,
    },
);
